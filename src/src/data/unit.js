...
export const UNITS = {
    human: {
      peasant:   { key: 'peasant',   name: 'Peasant',   cost: 30,  hp: 130, dmg: 16, range: 1, atkSpeed: 1.0, special: null },
      footman:   { key: 'footman',   name: 'Footman',   cost: 50,  hp: 240, dmg: 22, range: 1, atkSpeed: 1.0, special: null },
      ...
      knight:    { key: 'knight',    name: 'Knight',    cost: 120, hp: 480, dmg: 58, range: 1, atkSpeed: 0.9, special: 'splash' }
    },
    orc: {
      peon:        { key: 'peon',        name: 'Peon',         cost: 30,  hp: 130, dmg: 16, range: 1, atkSpeed: 1.0, special: null },
      grunt:       { key: 'grunt',       name: 'Grunt',        cost: 50,  hp: 240, dmg: 22, range: 1, atkSpeed: 1.0, special: null },
      ...
      tauren:      { key: 'tauren',      name: 'Tauren',       cost: 120, hp: 480, dmg: 50, range: 1, atkSpeed: 0.9, special: 'cleave' }
    },
    undead: {
      acolyte:     { key: 'acolyte',     name: 'Acolyte',      cost: 30,  hp: 130, dmg: 16, range: 1, atkSpeed: 1.0, special: null },
      ghoul:       { key: 'ghoul',       name: 'Ghoul',        cost: 50,  hp: 240, dmg: 22, range: 1, atkSpeed: 1.0, special: null },
      ...
      abomination: { key: 'abomination', name: 'Abomination',  cost: 120, hp: 480, dmg: 50, range: 1, atkSpeed: 0.9, special: 'cleave' }
    },
    nightelf: {
      treant:    { key: 'treant',    name: 'Treant',        cost: 30,  hp: 130, dmg: 16, range: 1, atkSpeed: 1.0, special: null },
      huntress:  { key: 'huntress',  name: 'Huntress',      cost: 50,  hp: 240, dmg: 22, range: 1, atkSpeed: 1.0, special: null },
      ...
      mountainGiant: { key: 'mountainGiant', name: 'Mtn Giant', cost: 120, hp: 480, dmg: 58, range: 1, atkSpeed: 0.9, special: 'splash' }
    }
  };
